...
func ComputeRootFromPath(h nearprimitive.HostFunction, path []nearprimitive.MerklePathItem, item_hash nearprimitive.MerkleHash) (nearprimitive.MerkleHash, error) {
	res := item_hash
	var err error
