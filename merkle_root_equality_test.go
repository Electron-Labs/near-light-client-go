...
func TestBlockMerkleRootVerification(t *testing.T) {
	err := BlockMerkleRootVerification(LIGHT_CLIENT_BLOCK, EXECUTION_OUTCOME)
	if err != nil {
		t.Errorf("failed to verify merkle rooot:%s", err)
	}
}
